...
- API version: Slurm-24.11.0&amp;openapi/slurmctld&amp;openapi/slurmdbd
...
```sh
pip install git+https://github.com/kayvontabrizi/slurm-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/kayvontabrizi/slurm-client.git`)
