...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0040_openapi_accounts_resp = slurm_client.V0040OpenapiAccountsResp() # V0040OpenapiAccountsResp | Description of accounts to update/create (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0040_openapi_accounts_add_cond_resp = slurm_client.V0040OpenapiAccountsAddCondResp() # V0040OpenapiAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0040_openapi_assocs_resp = slurm_client.V0040OpenapiAssocsResp() # V0040OpenapiAssocsResp | Job description (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    api_instance = slurm_client.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Filter reservations since update timestamp (optional)
    v0040_openapi_clusters_resp = slurm_client.V0040OpenapiClustersResp() # V0040OpenapiClustersResp | Cluster add or update descriptions (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0040_openapi_slurmdbd_config_resp = slurm_client.V0040OpenapiSlurmdbdConfigResp() # V0040OpenapiSlurmdbdConfigResp | Add or update config (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted QOS (optional)
    v0040_openapi_slurmdbd_qos_resp = slurm_client.V0040OpenapiSlurmdbdQosResp() # V0040OpenapiSlurmdbdQosResp | Description of QOS to add or update (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0040_openapi_tres_resp = slurm_client.V0040OpenapiTresResp() # V0040OpenapiTresResp | TRES descriptions. Only works in developer mode. (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0040_openapi_users_resp = slurm_client.V0040OpenapiUsersResp() # V0040OpenapiUsersResp | add or update user (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    flags = 'flags_example' # str | Query flags (optional)
    v0040_openapi_users_add_cond_resp = slurm_client.V0040OpenapiUsersAddCondResp() # V0040OpenapiUsersAddCondResp | Create users with conditional association (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted wckeys (optional)
    v0040_openapi_wckey_resp = slurm_client.V0040OpenapiWckeyResp() # V0040OpenapiWckeyResp | wckeys description (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0041_openapi_accounts_resp = slurm_client.V0041OpenapiAccountsResp() # V0041OpenapiAccountsResp | Description of accounts to update/create (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0041_openapi_accounts_add_cond_resp = slurm_client.V0041OpenapiAccountsAddCondResp() # V0041OpenapiAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0041_openapi_assocs_resp = slurm_client.V0041OpenapiAssocsResp() # V0041OpenapiAssocsResp | Job description (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    api_instance = slurm_client.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Filter reservations since update timestamp (optional)
    v0041_openapi_clusters_resp = slurm_client.V0041OpenapiClustersResp() # V0041OpenapiClustersResp | Cluster add or update descriptions (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0041_openapi_slurmdbd_config_resp = slurm_client.V0041OpenapiSlurmdbdConfigResp() # V0041OpenapiSlurmdbdConfigResp | Add or update config (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted QOS (optional)
    v0041_openapi_slurmdbd_qos_resp = slurm_client.V0041OpenapiSlurmdbdQosResp() # V0041OpenapiSlurmdbdQosResp | Description of QOS to add or update (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0041_openapi_tres_resp = slurm_client.V0041OpenapiTresResp() # V0041OpenapiTresResp | TRES descriptions. Only works in developer mode. (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0041_openapi_users_resp = slurm_client.V0041OpenapiUsersResp() # V0041OpenapiUsersResp | add or update user (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    update_time = 'update_time_example' # str | Filter partitions since update timestamp (optional)
    flags = 'flags_example' # str | Query flags (optional)
    v0041_openapi_users_add_cond_resp = slurm_client.V0041OpenapiUsersAddCondResp() # V0041OpenapiUsersAddCondResp | Create users with conditional association (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted wckeys (optional)
    v0041_openapi_wckey_resp = slurm_client.V0041OpenapiWckeyResp() # V0041OpenapiWckeyResp | wckeys description (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0042_openapi_accounts_resp = slurm_client.V0042OpenapiAccountsResp() # V0042OpenapiAccountsResp | Description of accounts to update/create (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0042_openapi_accounts_add_cond_resp = slurm_client.V0042OpenapiAccountsAddCondResp() # V0042OpenapiAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0042_openapi_assocs_resp = slurm_client.V0042OpenapiAssocsResp() # V0042OpenapiAssocsResp | Job description (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    api_instance = slurm_client.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Query reservations updated more recently than this time (UNIX timestamp) (optional)
    v0042_openapi_clusters_resp = slurm_client.V0042OpenapiClustersResp() # V0042OpenapiClustersResp | Cluster add or update descriptions (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0042_openapi_slurmdbd_config_resp = slurm_client.V0042OpenapiSlurmdbdConfigResp() # V0042OpenapiSlurmdbdConfigResp | Add or update config (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | CSV QOS name list (optional)
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    v0042_openapi_slurmdbd_qos_resp = slurm_client.V0042OpenapiSlurmdbdQosResp() # V0042OpenapiSlurmdbdQosResp | Description of QOS to add or update (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0042_openapi_tres_resp = slurm_client.V0042OpenapiTresResp() # V0042OpenapiTresResp | TRES descriptions. Only works in developer mode. (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurm_client.SlurmdbApi(api_client)
    v0042_openapi_users_resp = slurm_client.V0042OpenapiUsersResp() # V0042OpenapiUsersResp | add or update user (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    flags = 'flags_example' # str | Query flags (optional)
    v0042_openapi_users_add_cond_resp = slurm_client.V0042OpenapiUsersAddCondResp() # V0042OpenapiUsersAddCondResp | Create users with conditional association (optional)
...
with slurm_client.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted WCKeys (optional)
    v0042_openapi_wckey_resp = slurm_client.V0042OpenapiWckeyResp() # V0042OpenapiWckeyResp | wckeys description (optional)
