        ...
        if include_optional:
            return V0042AssocMaxJobs(
                per = slurm_client.models.v0_0_42_assoc_max_jobs_per.v0_0_42_assoc_max_jobs_per(
                    ...
                    submitted = , 
                    wall_clock = , ),
                active = slurm_client.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                accruing = slurm_client.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    ...
                    infinite = True, 
                    number = 56, ),
                total = slurm_client.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, )
            )
