...
class TestV0042Step(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0042Step:
        ...
        if include_optional:
            return V0042Step(
                time = slurm_client.models.v0_0_42_step_time.v0_0_42_step_time(
                    elapsed = 56, 
                    end = slurm_client.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    start = slurm_client.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    suspended = 56, 
                ...
                cpu = slurm_client.models.v0_0_42_step_cpu.v0_0_42_step_CPU(
                    requested_frequency = slurm_client.models.v0_0_42_step_cpu_requested_frequency.v0_0_42_step_CPU_requested_frequency(
                        min = slurm_client.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        max = slurm_client.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                            set = True, 
                            infinite = True, 
                            number = 56, ), ), 
                    governor = '', ),
                ...
                statistics = slurm_client.models.v0_0_42_step_statistics.v0_0_42_step_statistics(
                    cpu = slurm_client.models.v0_0_42_step_statistics_cpu.v0_0_42_step_statistics_CPU(
                        actual_frequency = 56, ), 
                ...
                tres = slurm_client.models.v0_0_42_step_tres.v0_0_42_step_tres(
                    ...
                    consumed = slurm_client.models.v0_0_42_step_tres_consumed.v0_0_42_step_tres_consumed(), 
                    allocated = , )
            )
        else:
            return V0042Step(
