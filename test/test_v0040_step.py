            ...
            return V0040Step(
                ...
                statistics = slurm_client.models.v0_0_40_step_statistics.v0_0_40_step_statistics(
                    ...
                    energy = slurm_client.models.v0_0_40_step_statistics_energy.v0_0_40_step_statistics_energy(
                        consumed = slurm_client.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                            set = True, 
                            infinite = True, 
                            number = 56, ), ), ),
                ...
                tres = slurm_client.models.v0_0_40_step_tres.v0_0_40_step_tres(
                    ...
                    consumed = slurm_client.models.v0_0_40_step_tres_consumed.v0_0_40_step_tres_consumed(), 
                    allocated = , )
            )
        else:
            return V0040Step(
