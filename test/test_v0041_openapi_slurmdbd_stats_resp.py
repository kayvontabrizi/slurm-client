    ...
    def make_instance(self, include_optional) -> V0041OpenapiSlurmdbdStatsResp:
        ...
        if include_optional:
            return V0041OpenapiSlurmdbdStatsResp(
                statistics = slurm_client.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics.v0_0_41_openapi_slurmdbd_stats_resp_statistics(
                    time_start = 56, 
                    rollups = slurm_client.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups(
                        ...
                        monthly = slurm_client.models.v0_0_42_rollup_stats_monthly.v0_0_42_rollup_stats_monthly(
                            ...
                            last_run = 56, ), ), 
                    rpcs = [
                        slurm_client.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rpcs_inner.v0_0_41_openapi_slurmdbd_stats_resp_statistics_RPCs_inner(
                            rpc = '', 
                            count = 56, 
                    ...
                    users = [
                        slurm_client.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner.v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner(
                            user = '', 
                            count = 56, )
                        ], ),
