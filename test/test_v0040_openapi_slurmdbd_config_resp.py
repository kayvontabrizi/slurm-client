    ...
    def make_instance(self, include_optional) -> V0040OpenapiSlurmdbdConfigResp:
        ...
        if include_optional:
            return V0040OpenapiSlurmdbdConfigResp(
                clusters = [
                    slurm_client.models.v0/0/40_cluster_rec.v0.0.40_cluster_rec(
                        ...
                        nodes = '', 
                        select_plugin = '', 
                        associations = slurm_client.models.v0_0_40_cluster_rec_associations.v0_0_40_cluster_rec_associations(
                            root = slurm_client.models.v0/0/40_assoc_short.v0.0.40_assoc_short(
                                account = '', 
                                cluster = '', 
                                partition = '', 
                                user = '', 
                ...
                accounts = [
                    slurm_client.models.v0/0/40_account.v0.0.40_account(
                        associations = [
                            slurm_client.models.v0/0/40_assoc_short.v0.0.40_assoc_short(
                                account = '', 
                                cluster = '', 
                                partition = '', 
                                user = '', 
                        ...
                        coordinators = [
                            slurm_client.models.v0/0/40_coord.v0.0.40_coord(
                                name = '', 
                                direct = True, )
                            ], 
                        description = '', 
                ...
                users = [
                    slurm_client.models.v0/0/40_user.v0.0.40_user(
                        administrator_level = [
                            'Not Set'
                            ], 
                        associations = [
                        ...
                        old_name = '', 
                        wckeys = [
                            slurm_client.models.v0/0/40_wckey.v0.0.40_wckey(
                                accounting = [
                ...
                qos = [
                    slurm_client.models.v0/0/40_qos.v0.0.40_qos(
                        description = '', 
                        flags = [
                            'NOT_SET'
                            ], 
                        id = 56, 
                        limits = slurm_client.models.v0_0_40_qos_limits.v0_0_40_qos_limits(
                            grace_time = 56, 
                            max = slurm_client.models.v0_0_40_qos_limits_max.v0_0_40_qos_limits_max(
                                active_jobs = slurm_client.models.v0_0_40_qos_limits_max_active_jobs.v0_0_40_qos_limits_max_active_jobs(
                                    ...
                                    count = slurm_client.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                                        ...
                                        infinite = True, 
                                        number = 56, ), ), 
                                tres = slurm_client.models.v0_0_40_qos_limits_max_tres.v0_0_40_qos_limits_max_tres(
                                    total = [
                                        slurm_client.models.v0/0/40_tres.v0.0.40_tres(
                                            type = '', 
                                            name = '', 
                                    ...
                                    minutes = slurm_client.models.v0_0_40_qos_limits_max_tres_minutes.v0_0_40_qos_limits_max_tres_minutes(
                                        per = slurm_client.models.v0_0_40_qos_limits_max_tres_minutes_per.v0_0_40_qos_limits_max_tres_minutes_per(
                                            qos = [
                                                slurm_client.models.v0/0/40_tres.v0.0.40_tres(
                                                    type = '', 
                                                    name = '', 
                                            ...
                                            account = , 
                                            user = , ), ), 
                                    per = slurm_client.models.v0_0_40_qos_limits_max_tres_per.v0_0_40_qos_limits_max_tres_per(
                                        node = , ), ), 
                                wall_clock = slurm_client.models.v0_0_40_qos_limits_max_wall_clock.v0_0_40_qos_limits_max_wall_clock(), 
                                jobs = slurm_client.models.v0_0_40_qos_limits_max_jobs.v0_0_40_qos_limits_max_jobs(), 
                                accruing = slurm_client.models.v0_0_40_qos_limits_max_jobs_active_jobs.v0_0_40_qos_limits_max_jobs_active_jobs(), ), 
                            factor = slurm_client.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                                set = True, 
                                infinite = True, 
                                number = 1.337, ), 
                            min = slurm_client.models.v0_0_40_qos_limits_min.v0_0_40_qos_limits_min(
                                priority_threshold = , ), ), 
                        name = '', 
                        preempt = slurm_client.models.v0_0_40_qos_preempt.v0_0_40_qos_preempt(
                            list = [
                                ''
                                ], 
                            mode = [
                            ...
                            exempt_time = , ), 
                        priority = , 
                        usage_factor = slurm_client.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                            set = True, 
                            infinite = True, 
                            number = 1.337, ), 
                        usage_threshold = , )
