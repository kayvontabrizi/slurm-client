    ...
    def make_instance(self, include_optional) -> V0042JobDescMsg:
        ...
        if include_optional:
            return V0042JobDescMsg(
                ...
                array = '',
                batch_features = '',
                begin_time = slurm_client.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                flags = [
                ...
                cpu_frequency = '',
                cpus_per_tres = '',
                crontab = slurm_client.models.v0/0/42_cron_entry.v0.0.42_cron_entry(
                    flags = [
                        'WILD_MINUTE'
                        ], 
                    minute = '', 
                    ...
                    specification = '', 
                    command = '', 
                    line = slurm_client.models.v0_0_42_cron_entry_line.v0_0_42_cron_entry_line(
                        start = 56, 
                        end = 56, ), ),
                deadline = 56,
                delay_boot = 56,
                ...
                rlimits = slurm_client.models.v0_0_42_job_desc_msg_rlimits.v0_0_42_job_desc_msg_rlimits(
                    cpu = slurm_client.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    fsize = slurm_client.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    data = , 
                ...
                overcommit = True,
                partition = '',
                distribution_plane_size = slurm_client.models.v0/0/42_uint16_no_val_struct.v0.0.42_uint16_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                power_flags = [
                ...
                kill_warning_signal = '',
                kill_warning_delay = slurm_client.models.v0/0/42_uint16_no_val_struct.v0.0.42_uint16_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                ...
                selinux_context = '',
                required_switches = slurm_client.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                segment_size = slurm_client.models.v0/0/42_uint16_no_val_struct.v0.0.42_uint16_no_val_struct(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                standard_error = '',
